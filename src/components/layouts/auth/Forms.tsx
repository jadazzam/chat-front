...
export const SignInForm = () => {
  return (
    <SignInFormWrapper>
      <AuthForm.TextField id="email" label="Required" name="email" placeholder="john@example.com" />
...
export const SignUpForm = () => {
  return (
    <SignUpFormWrapper>
      <AuthForm.TextField id="name" label="Required" name="name" placeholder="John" />
      <AuthForm.TextField id="email" label="Required" name="email" placeholder="john@example.com" />
      <AuthForm.TextField id="password" label="password" name="password" placeholder="password" />
